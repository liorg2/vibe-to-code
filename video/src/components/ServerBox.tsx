...
import { BOX_H, BOX_W, COLORS, FONT, SERVER_LEFT, STAGE_Y } from "./theme";
import { focusGlow } from "./glow";

export function ServerBox({ active }: { active: boolean }) {
  ...
  return (
    ...
    >
      <div style={{ padding: "18px 24px 0", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <Server size={22} color={COLORS.acc2} strokeWidth={2} />
