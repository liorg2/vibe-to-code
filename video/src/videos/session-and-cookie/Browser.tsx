...
// Copied from components/BrowserBox.tsx and tweaked for a sign-in beat instead of a fetch beat
// (this video's own copy, per the "copy if you need to change it" rule).
const DOTS_H = 40;
const GAP1 = 8;
const BAR_H = 32;
const GAP2 = 14;
...
export function Browser({ active, buttonScale = 1 }: { active: boolean; buttonScale?: number }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ fontFamily: FONT, fontWeight: 700, fontSize: 17, color: "#fff" }}>Sign in</span>
      </div>
      <div
        style={{
          position: "absolute",
