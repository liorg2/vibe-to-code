...
export const BUILD_DONE_N: Record<string, number> = {
  ground: 4, vcs: 4, sides: 4, langs: 3, frontend: 4, http: 3, data: 4,
  async: 4, memory: 3, cache: 4, apis: 4, testing: 3, auth: 4, security: 4,
  net: 4, cloud: 4, devops: 4, observe: 4, scale: 4, team: 3, ai: 4,
};
