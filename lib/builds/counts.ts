...
export const BUILD_DONE_N: Record<string, number> = {
  ground: 4, vcs: 4, sides: 4, langs: 3, frontend: 4, mobile: 3, httpdata: 4,
  integrations: 4, performance: 4, teamwork: 4, security: 4, pay: 4,
  netcloud: 4, devops: 4, observe: 4, scale: 4, llm: 4, ai: 4,
};
